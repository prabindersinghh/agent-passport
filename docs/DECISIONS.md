...
| 2026-08-26 | MCP enforcement via adapter intercept, not standalone proxy | v0.1 scope; contract proven in tests; proxy is v0.2 |
| 2026-08-26 | Run summaries from audit events only | PRD §11; LLM narrative optional, never authoritative |
| 2026-08-26 | Python SDK delegates authorize to CLI subprocess | v0.1 speed; native evaluator is pending (see PROGRESS) |
